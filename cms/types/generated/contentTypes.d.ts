...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Actualit\u00E9s du site \u2014 br\u00E8ves et articles de fond';
    displayName: 'Article';
    pluralName: 'articles';
  ...
  attributes: {
    chapo: Schema.Attribute.Text & Schema.Attribute.Required;
    contenu: Schema.Attribute.RichText & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    date_publication: Schema.Attribute.Date & Schema.Attribute.Required;
    format: Schema.Attribute.Enumeration<['breve', 'article_de_fond']> &
      Schema.Attribute.Required;
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    reserve_adherents: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<false>;
    secteur: Schema.Attribute.Relation<'manyToOne', 'api::structure.structure'>;
...
export interface ApiCapsuleCapsule extends Struct.CollectionTypeSchema {
  collectionName: 'capsules';
  info: {
    description: 'Capsules p\u00E9dagogiques interactives (conventions collectives)';
    displayName: 'Capsule';
    pluralName: 'capsules';
    singularName: 'capsule';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    image_couverture: Schema.Attribute.Media<'images'> &
      Schema.Attribute.Required;
    lien_genially: Schema.Attribute.String & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::capsule.capsule'
...
export interface ApiMagazineMagazine extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Num\u00E9ros de magazines h\u00E9berg\u00E9s sur Calameo';
  ...
  attributes: {
    ...
    image_couverture: Schema.Attribute.Media<'images'> &
      Schema.Attribute.Required;
    lien_calameo: Schema.Attribute.String & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiMembreMembre extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Personnes physiques \u2014 \u00E9lus, responsables de structures';
    displayName: 'Membre';
    pluralName: 'membres';
    singularName: 'membre';
  };
...
export interface ApiPartenairePartenaire extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: "Logos partenaires affich\u00E9s sur la page d'accueil et le footer";
...
export interface ApiPressePresse extends Struct.CollectionTypeSchema {
  collectionName: 'presses';
  info: {
    description: 'Communiqu\u00E9s, dossiers de presse, phototh\u00E8que, revue de presse';
    displayName: 'Presse';
    pluralName: 'presses';
    singularName: 'presse';
  };
  ...
  attributes: {
    ...
    type: Schema.Attribute.Enumeration<
      ['communique', 'dossier_de_presse', 'photo_kit_media', 'revue_de_presse']
    > &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiStructureStructure extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'F\u00E9d\u00E9ration, syndicats (SNEC/SNES) et USN';
  ...
  attributes: {
    ...
    bureau: Schema.Attribute.Component<'structure.bureau-membre', true>;
    capsules: Schema.Attribute.Relation<'oneToMany', 'api::capsule.capsule'>;
    conventions_collectives: Schema.Attribute.Component<
      'structure.convention-collective',
      true
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
    ...
    syndicat_parent: Schema.Attribute.Relation<
      'manyToOne',
      'api::structure.structure'
    >;
    ...
    >;
    type: Schema.Attribute.Enumeration<['federation', 'syndicat', 'usn']> &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    usns: Schema.Attribute.Relation<'oneToMany', 'api::structure.structure'>;
  };
}
...
export interface ApiTagTag extends Struct.CollectionTypeSchema {
  collectionName: 'tags';
  info: {
    description: 'Tags th\u00E9matiques pour filtrer les articles';
    displayName: 'Tag';
    pluralName: 'tags';
    singularName: 'tag';
  };
...
export interface ApiTemoignageTemoignage extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: "T\u00E9moignages d'adh\u00E9rents affich\u00E9s sur la page d'accueil";
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::capsule.capsule': ApiCapsuleCapsule;
